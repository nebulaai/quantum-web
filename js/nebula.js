const admin_abi_json = "/quantum-web/contract/abi/getter/admin_interface.json";
const client_abi_json = "/quantum-web/contract/abi/submitter/ClientInterfaceSubmitter.json";
const dispatcher_abi_json = "/quantum-web/contract/abi/submitter/DispatcherInterfaceSubmitter.json";
const distributor_abi_json = "/quantum-web/contract/abi/submitter/DistributorInterfaceSubmitter.json";
const queue_task_abi_json = "";
const queue_ai_abi_json = "";
const taskpool_abi_json = "/quantum-web/contract/abi/getter/TaskPoolInterfaceGetter.json";
const account_abi_json = "/quantum-web/contract/abi/getter/AccountInterfaceGetters.json";
